...
class ExerciseControllerTest extends TestCase
{
     ...
     * @return void
     */
    public function test_index_exercise() //4
    {
    ...
    public function test_store_exercise() //5
    {
        $data = [
            'name' => 'name1',
    ...
    public function test_show_exercise() //4
    {
        $item = Exercise::factory()->create();
    ...
    public function test_update_exercise() //2
    {
        $item = Exercise::factory()->create();
        $data = [
            'name' => 'name_update',
    ...
    public function test_delete_exercise() //2
    {
        $item = Exercise::factory()->create();
